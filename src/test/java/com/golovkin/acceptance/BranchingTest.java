...
public class BranchingTest extends AbstractAcceptanceTest {
    ...
    public class Checkout {
        ...
        public void successful_checkout_first_project_has_checkpoint_second_does_not_have_checkpoint() {
            gitStub().add("--git-dir (.+) status", "On branch current_branch\nnothing to commit, working tree clean", 0)
                    .add("--git-dir (.+) rev-parse --verify sample_branch", "e65f46ad23748e015780f395683ca2d9551ab221", 0)
                    .add("--git-dir (.+) commit -a -m \"\\[GROOT\\] ~Checkpoint~\"", "[current_branch bac20dd] Hello\n 1 file changed, 1 insertion(+)  create mode 100644 ok", 0)
            ...
            check().assertGitRequestsEqual(
                    ...
                    "--git-dir omniutils_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\"",
                    "--git-dir omniutils_dir/.git checkout sample_branch",
                    ...
                    "--git-dir omniloan_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\"",
                    "--git-dir omniloan_dir/.git checkout sample_branch",
                    "--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\""
            );

            check().assertLogsEqual(
                    new GrootLogEntry(LogLevel.INFO, "[omniutils] Переход из ветки [current_branch] в ветку [sample_branch]. Переход в ветку [sample_branch] успешно завершен. Команды - [--git-dir omniutils_dir/.git rev-parse --verify sample_branch;--git-dir omniutils_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniutils_dir/.git checkout sample_branch;--git-dir omniutils_dir/.git log -1 --pretty=\"%H %B\";--git-dir omniutils_dir/.git reset --soft HEAD~1]"),
                    new GrootLogEntry(LogLevel.INFO, "[omniloan] Переход из ветки [current_branch] в ветку [sample_branch]. Переход в ветку [sample_branch] успешно завершен. Команды - [--git-dir omniloan_dir/.git rev-parse --verify sample_branch;--git-dir omniloan_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniloan_dir/.git checkout sample_branch;--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"]")
            );
        }
        ...
        public void one_project_does_not_have_needed_branch() {
            gitStub().add("--git-dir (.+) status", "On branch current_branch\nnothing to commit, working tree clean", 0)
                    .add("--git-dir omniutils_dir/.git rev-parse --verify sample_branch", "fatal: Needed a single revision", 1)
                    .add("--git-dir omniloan_dir/.git rev-parse --verify sample_branch", "e65f46ad23748e015780f395683ca2d9551ab221", 0)
                    .add("--git-dir (.+) commit -a -m \"\\[GROOT\\] ~Checkpoint~\"", "[current_branch bac20dd] Hello  1 file changed, 1 insertion(+)  create mode 100644 ok", 0)
                    .add("--git-dir (.+) checkout sample_branch", "", 0)
                    .add("--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"", "e65f46ad23748e015780f395683ca2d9551ab221 Hello", 0)
                    .add("--git-dir (.+) reset --soft HEAD~1", "", 0)
                    .create();
        ...
        public void cannot_check_branch_existence_in_one_project() {
            gitStub().add("--git-dir (.+) status", "On branch current_branch\nnothing to commit, working tree clean", 0)
                    .add("--git-dir omniutils_dir/.git rev-parse --verify sample_branch", "some unexpected\nerror", 1)
                    .add("--git-dir omniloan_dir/.git rev-parse --verify sample_branch", "e65f46ad23748e015780f395683ca2d9551ab221", 0)
                    .add("--git-dir (.+) commit -a -m \"\\[GROOT\\] ~Checkpoint~\"", "[current_branch bac20dd] Hello  1 file changed, 1 insertion(+)  create mode 100644 ok", 0)
                    .add("--git-dir (.+) checkout sample_branch", "", 0)
                    .add("--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"", "e65f46ad23748e015780f395683ca2d9551ab221 Hello", 0)
            ...
            check().assertLogsEqual(
                    new GrootLogEntry(LogLevel.ERROR, "[omniutils] Переход из ветки [current_branch] в ветку [sample_branch]. Не удалось перейти в ветку [sample_branch]. Причина ошибки - [some unexpected error]. Команды - [--git-dir omniutils_dir/.git rev-parse --verify sample_branch]"),
                    new GrootLogEntry(LogLevel.INFO, "[omniloan] Переход из ветки [current_branch] в ветку [sample_branch]. Переход в ветку [sample_branch] успешно завершен. Команды - [--git-dir omniloan_dir/.git rev-parse --verify sample_branch;--git-dir omniloan_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniloan_dir/.git checkout sample_branch;--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"]")
            );
        }
        ...
        public void one_project_does_not_have_work_to_save() {
            gitStub().add("--git-dir (.+) status", "On branch current_branch\nnothing to commit, working tree clean", 0)
                    .add("--git-dir (.+) rev-parse --verify sample_branch", "e65f46ad23748e015780f395683ca2d9551ab221", 0)
                    .add("--git-dir omniutils_dir/.git commit -a -m \"\\[GROOT\\] ~Checkpoint~\"", "On branch current_branch\nnothing to commit, working tree clean", 1)
                    .add("--git-dir omniloan_dir/.git commit -a -m \"\\[GROOT\\] ~Checkpoint~\"", "[current_branch bac20dd] Hello  1 file changed, 1 insertion(+)  create mode 100644 ok", 0)
                    .add("--git-dir (.+) checkout sample_branch", "", 0)
                    .add("--git-dir omniutils_dir/.git log -1 --pretty=\"%H %B\"", "e65f46ad23748e015780f395683ca2d9551ab221 [GROOT] ~Checkpoint~", 0)
                    .add("--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"", "e65f46ad23748e015780f395683ca2d9551ab221 Hello", 0)
                    .add("--git-dir (.+) reset --soft HEAD~1", "", 0)
        ...
        public void cannot_save_work_in_one_project() {
            gitStub().add("--git-dir (.+) status", "On branch current_branch\nnothing to commit, working tree clean", 0)
                    .add("--git-dir (.+) rev-parse --verify sample_branch", "e65f46ad23748e015780f395683ca2d9551ab221", 0)
                    .add("--git-dir omniutils_dir/.git commit -a -m \"\\[GROOT\\] ~Checkpoint~\"", "some unexpected\nerror", 1)
                    .add("--git-dir omniloan_dir/.git commit -a -m \"\\[GROOT\\] ~Checkpoint~\"", "[current_branch bac20dd] Hello  1 file changed, 1 insertion(+)  create mode 100644 ok", 0)
                    .add("--git-dir (.+) checkout sample_branch", "", 0)
                    .add("--git-dir omniutils_dir/.git log -1 --pretty=\"%H %B\"", "e65f46ad23748e015780f395683ca2d9551ab221 [GROOT] ~Checkpoint~", 0)
                    .add("--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"", "e65f46ad23748e015780f395683ca2d9551ab221 Hello", 0)
            ...
            check().assertLogsEqual(
                    new GrootLogEntry(LogLevel.ERROR, "[omniutils] Переход из ветки [current_branch] в ветку [sample_branch]. Не удалось перейти в ветку [sample_branch]. Причина ошибки - [some unexpected error]. Команды - [--git-dir omniutils_dir/.git rev-parse --verify sample_branch;--git-dir omniutils_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\"]"),
                    new GrootLogEntry(LogLevel.INFO, "[omniloan] Переход из ветки [current_branch] в ветку [sample_branch]. Переход в ветку [sample_branch] успешно завершен. Команды - [--git-dir omniloan_dir/.git rev-parse --verify sample_branch;--git-dir omniloan_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniloan_dir/.git checkout sample_branch;--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"]")
            );
        }
        ...
        public void cannot_checkout_in_one_project() {
            ...
            check().assertLogsEqual(
                    new GrootLogEntry(LogLevel.ERROR, "[omniutils] Переход из ветки [current_branch] в ветку [sample_branch]. Не удалось перейти в ветку [sample_branch]. Причина ошибки - [some unexpected error]. Команды - [--git-dir omniutils_dir/.git rev-parse --verify sample_branch;--git-dir omniutils_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniutils_dir/.git checkout sample_branch]"),
                    new GrootLogEntry(LogLevel.INFO, "[omniloan] Переход из ветки [current_branch] в ветку [sample_branch]. Переход в ветку [sample_branch] успешно завершен. Команды - [--git-dir omniloan_dir/.git rev-parse --verify sample_branch;--git-dir omniloan_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniloan_dir/.git checkout sample_branch;--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"]")
            );
        }
        ...
        public void cannot_check_last_commit_in_one_project() {
            ...
            check().assertLogsEqual(
                    new GrootLogEntry(LogLevel.ERROR, "[omniutils] Переход из ветки [current_branch] в ветку [sample_branch]. Не удалось перейти в ветку [sample_branch]. Причина ошибки - [some unexpected error]. Команды - [--git-dir omniutils_dir/.git rev-parse --verify sample_branch;--git-dir omniutils_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniutils_dir/.git checkout sample_branch;--git-dir omniutils_dir/.git log -1 --pretty=\"%H %B\"]"),
                    new GrootLogEntry(LogLevel.INFO, "[omniloan] Переход из ветки [current_branch] в ветку [sample_branch]. Переход в ветку [sample_branch] успешно завершен. Команды - [--git-dir omniloan_dir/.git rev-parse --verify sample_branch;--git-dir omniloan_dir/.git commit -a -m \"[GROOT] ~Checkpoint~\";--git-dir omniloan_dir/.git checkout sample_branch;--git-dir omniloan_dir/.git log -1 --pretty=\"%H %B\"]")
            );
        }
